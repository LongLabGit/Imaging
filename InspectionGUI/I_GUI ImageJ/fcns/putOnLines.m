...
if isempty(handles.roi_trace{handles.assignedR(1)})
    ...
    handles.line(2)=line(handles.roi1,t*[1,1],[0,max(handles.roi_trace{handles.assignedR(1)})],'color','r');
    ylim(handles.roi1,[0,max(handles.roi_trace{handles.assignedR(1)})])
end
if isempty(handles.roi_trace{handles.assignedR(2)})
    handles.line(3)=line(handles.roi2,t*[1,1],[0,handles.maxI],'color','r');
else
    handles.line(3)=line(handles.roi2,t*[1,1],[0,max(handles.roi_trace{handles.assignedR(2)})],'color','r');
    ylim(handles.roi2,[0,max(handles.roi_trace{handles.assignedR(2)})])
end
if isempty(handles.roi_trace{handles.assignedR(3)})
    handles.line(4)=line(handles.roi3,t*[1,1],[0,handles.maxI],'color','r');
else
    handles.line(4)=line(handles.roi3,t*[1,1],[0,max(handles.roi_trace{handles.assignedR(3)})],'color','r');
    ylim(handles.roi3,[0,max(handles.roi_trace{handles.assignedR(3)})])
end
