...
if isempty(sn)
    if strcmpi(options.noise_method, 'paul')
        noise_frames = options.noise_range;
        sn = estimate_noise_local(y_full, noise_frames);
    else
